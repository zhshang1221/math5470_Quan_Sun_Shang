...
Set file path and ready for environment
```{r}
library(plotrix)
rm(list=ls())
...
Plot monthly out-of-sample R_oos result, and monthly out-of-sample R_oos without OLS
```{r}
par(mfrow=c(1,2))
...
barplot(height=monthly_data, main = "Monthly Prediction Performance", beside=TRUE, col= cm.colors(3), args.legend=c(35,28, "bottomright"))
...
plot(complexity_info$year, complexity_info$PLS, main='PLS', col="#CD0074",ylab="# of Comp.", xlab="Year", 'o')
plot(complexity_info$year, complexity_info$PCR, main='PCR', col="#CD0074",ylab="# of Comp.", xlab="Year", 'o')
plot(complexity_info$year, complexity_info$GL, main='Generalized Linear', col="#CD0074",ylab="# of Char.", xlab="Year", 'o')
plot(complexity_info$year, complexity_info$BoostTree, main='Boost Tree', col="#CD0074",ylab="# of Char.", xlab="Year", 'o')
```
